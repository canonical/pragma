...
- We currently require Bun v1.3+. Please run `bun upgrade` to update to the latest version, or install with `curl -fsSL https://bun.com/install | bash`.
  - On Windows: `iex "& {$(irm https://bun.com/install.ps1)}"`
