 ...
 * detail) already exists there too and stays.
 *
...
const routes = {
  components: route({
    ...
    content: () => (
      <LensPlaceholder
        builtBy="P-5 (catalog and entity views)"
        lands="The component catalog — browse, filter, then one component in depth: usage, structure, tokens, its graph neighborhood."
        title="Components"
      />
    ),
  }),
