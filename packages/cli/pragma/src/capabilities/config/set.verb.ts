 ...
 * is now the ONLY config setter. Its write path is `runSet`, which inherits
 * reset sentinels, enum re-validation, and the global-layer-only write from the
 * {@link CONFIG_FIELDS} table.
 *
