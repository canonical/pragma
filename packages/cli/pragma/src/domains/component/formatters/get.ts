/**
 * Formatters for `pragma component get` output.
 *
 * Pure functions: ComponentGetInput → string.
...
import type { ComponentGetInput } from "./types.js";

const formatters: Formatters<ComponentGetInput> = {
...
function formatSummary(component: ComponentDetailed): string {
  const lines: string[] = [];
