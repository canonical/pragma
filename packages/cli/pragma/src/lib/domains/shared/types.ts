 ...
 *
 * These types form the contract between the operations layer and the
 * CLI/MCP adapters. Operations produce these types; adapters consume
 * them and render the same data in different presentations (terminal,
 * JSON, LLM-friendly text).
 */
