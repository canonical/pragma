/**
 * Compile-time type tests for shared operation return types.
 *
 * Asserts that shared operation return types match the contracts defined
 * in the types module. These are the types that form the boundary between
 * operations and CLI/MCP adapters.
 *
...
import { getModifier } from "../modifier/getModifier.js";
import { listModifiers } from "../modifier/listModifiers.js";
import { getStandard } from "../standard/getStandard.js";
import { listCategories } from "../standard/listCategories.js";
import { listStandards } from "../standard/listStandards.js";
import { listTiers } from "../tier/listTiers.js";
import { getToken } from "../token/getToken.js";
import { listTokens } from "../token/listTokens.js";
import type {
  AnatomyNode,
  AnatomyTree,
  CategorySummary,
