/**
 * Operations that query the ke store for detailed code standard data.
 *
 ...
 *
 * Queries the ke store for a cso:CodeStandard by name, then fetches its
 * associated "do" and "dont" code examples. Returns the full standard
 * detail including category, description, and code blocks.
 *
 * @note Impure — performs SPARQL queries against the ke store.
