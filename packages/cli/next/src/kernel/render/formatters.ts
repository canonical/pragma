 ...
 * global flags with a fixed precedence: `--format json` wins, then `--llm`,
 * then the plain terminal default. The dispatcher uses the plain/llm branches
 * directly and wraps the json branch in the machine envelope (D3).
 */
