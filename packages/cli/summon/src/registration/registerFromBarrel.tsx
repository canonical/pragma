...
const summonHost: CommanderHost = {
  registerFlags: registerStandardFlags,
  helpFlags: STANDARD_FLAG_HELP,
  ...
  // The projection's designed outcomes (usage errors, bare-namespace help)
  // take the default presentation: the parity bytes on stderr, the
  // outcome's exit code — the one shared process effect.
  emit: emitToProcess,
};
