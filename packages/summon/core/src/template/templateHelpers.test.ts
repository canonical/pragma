...
describe("templateHelpers", () => {
  ...
  describe("kebabCase", () => {
    ...
    it("handles consecutive uppercase", () => {
      expect(templateHelpers.kebabCase("XMLParser")).toBe("xml-parser");
    });
    it("handles mixed case with boundaries", () => {
  ...
  describe("isoDate", () => {
    it("returns ISO date string", () => {
      expect(templateHelpers.isoDate()).toMatch(
  ...
  describe("indent", () => {
    ...
    it("indents multiple lines", () => {
      expect(templateHelpers.indent("line1\nline2\nline3", 2)).toBe(
        "  line1\n  line2\n  line3",
      );
    });
