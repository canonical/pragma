  ...
  generate: (answers) => {
    ...
    return sequence_([
      ...
      template({
        ...
        content: svelteTemplates.component.content || undefined,
      ...
      template({
        ...
        content: svelteTemplates.types.content || undefined,
      ...
      template({
        ...
        content: svelteTemplates.index.content || undefined,
      ...
      template({
        ...
        content: svelteTemplates.test.content || undefined,
      ...
      when(
        ...
        template({
          ...
          content: svelteTemplates.ssrTest.content || undefined,
      ...
      when(
        ...
        template({
          ...
          content: svelteTemplates.storiesSvelte.content || undefined,
      ...
      when(
        ...
        template({
          ...
          content: svelteTemplates.storiesTs.content || undefined,
      ...
      when(
        ...
        template({
          ...
          content: svelteTemplates.styles.content || undefined,
