...
Requires both --ssr and --router flags.`,
  ...
  generate: (answers) => {
    ...
    // A verbatim asset, materialized from the embedded registry rather than
    // read off a filesystem the compiled binary does not have. Deliberately
    // still a `copyFile`: a `writeFile` would pass through summon's stamp
    // transform and prepend a "Generated by" comment to every `.ts`/`.tsx`/
    // `.css` asset, changing what the scaffold puts on disk.
    const copy = (filePath: string) =>
      copyFile(src(filePath), dest(filePath), {
        content: loadTemplateSync(src(filePath)),
      });
    ...
    return flatMap(resolvePragmaVersion(), (pragmaVersion) => {
      ...
      return sequence_([
        ...
        template({
          ...
          content: loadTemplateSync(src("package.json.ejs")),
          dest: dest("package.json"),
          vars,
        }),
        template({
          source: src("README.md.ejs"),
          content: loadTemplateSync(src("README.md.ejs")),
          dest: dest("README.md"),
          vars,
        }),
        template({
          source: src("biome.json.ejs"),
          content: loadTemplateSync(src("biome.json.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("tsconfig.json.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("vite.config.ts.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("vitest.setup.ts.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("index.html.ejs")),
        ...
        copyFile(src("gitignore"), dest(".gitignore"), {
          content: loadTemplateSync(src("gitignore")),
        }),
        ...
        template({
          ...
          content: loadTemplateSync(src("src/styles/index.css.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("src/client/entry.tsx.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("src/server/entry.tsx.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("src/sitemap/getSitemapItems.ts.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src("src/routes.tsx.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(
            src("src/lib/Navigation/Navigation.tsx.ejs"),
          ),
        ...
        template({
          ...
          content: loadTemplateSync(src("src/lib/index.ts.ejs")),
        ...
        template({
          ...
          content: loadTemplateSync(src(".storybook/main.ts.ejs")),
