 ...
 * train means our version IS the train's version). Same rationale and shape
 * as summon-package's packageVersion: not a JSON import (build-layout
 * coupling), lazy and cached (no IO at module load).
 *
