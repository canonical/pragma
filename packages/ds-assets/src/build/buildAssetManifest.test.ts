...
describe("buildAssetManifest", () => {
  ...
  it("writes a sorted, importable TypeScript manifest when manifestPath is provided", () => {
    const sourceDir = makeSourceDir({
      "z-icon.svg": "<svg>z</svg>",
      "a-icon.svg": "<svg>a</svg>",
    });
    const manifestPath = join(sourceDir, "generated", "manifest.ts");
    ...
    ).toBe(`// AUTO-GENERATED by buildAssetManifest — do not edit by hand.
const assetManifest = {
  "a-icon": "a-icon.${hashOf("<svg>a</svg>")}.svg",
  "z-icon": "z-icon.${hashOf("<svg>z</svg>")}.svg",
} as const;
