...
describe("Color (presentational)", () => {
  ...
  it("calls onChange with the hex when a swatch is clicked", () => {
    ...
    const { container } = render(
      <Color value="#000000" swatches={["#ef4444"]} onChange={onChange} />,
    );
  ...
  it("renders an inline hex input when there are no swatches", () => {
    const { container } = render(<Color value="#000000" swatches={[]} />);
    expect(
  ...
  it("supports the disabled state", () => {
    render(<Color value="#000000" disabled />);
