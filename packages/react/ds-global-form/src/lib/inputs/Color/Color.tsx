...
import type { ColorPresentationProps, HexFormat } from "./types.js";
import "./styles.css";
...
/**
 * Presentational color input with swatch grid and hex text input.
 *
...
export const Color = ({
  ...
  disabled = false,
  ...otherProps
}: ColorPresentationProps): React.ReactElement => {
