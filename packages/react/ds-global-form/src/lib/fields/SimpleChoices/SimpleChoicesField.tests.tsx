...
describe("SimpleChoicesField", () => {
  it("renders radio inputs by default", () => {
    renderWithForm(<SimpleChoicesField name="color" options={options} />);
    expect(screen.getAllByRole("radio")).toHaveLength(3);
  });

  it("renders checkbox inputs when isMultiple", () => {
    renderWithForm(
      <SimpleChoicesField name="colors" options={options} isMultiple />,
    );
  ...
  it("supports disabled state on all options", () => {
    renderWithForm(
      <SimpleChoicesField name="color" options={options} disabled />,
    );
  ...
  it("supports per-option disabled", () => {
    ...
    renderWithForm(<SimpleChoicesField name="color" options={opts} />);
