 ...
 * renderer reads, the settings menu a table installs in its settings cell
 * and what it was given as its settings reads, and the contract a
 * virtualization descriptor carries
