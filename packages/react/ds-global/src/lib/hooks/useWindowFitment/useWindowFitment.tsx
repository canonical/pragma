...
>({
  ...
  // scrolling ancestors. Respect the public scrollDelay contract while
  // coalescing a burst of nested/window/visual viewport events.
  useEffect(() => {
    ...
    return () => {
      ...
      schedulePositionUpdate.cancel();
    };
  }, [isServer, positioningActive, scrollDelay]);
