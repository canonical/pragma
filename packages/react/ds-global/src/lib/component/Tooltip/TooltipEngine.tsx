...
import type { TooltipEngineProps } from "./types.js";
 ...
 * client only, positions it against the target span, and points the arrow.
 * {@link withTooltip} builds on this; render it directly when the message
 * must follow prop state (e.g. a toggle whose tooltip names the current
 * action).
 *
 * `import { TooltipEngine } from "@canonical/react-ds-global";`
 */
const TooltipEngine = ({
  children,
  style,
