...
describe("TooltipEngine", () => {
  ...
  it("keeps the same target element identity across rerenders", () => {
    ...
    // One stable element across prop changes — the reason a state-reactive
    // consumer renders the engine directly instead of picking between two
    // withTooltip-wrapped component types (which would remount the target,
    // dropping focus and hover state).
