    ...
    docs: {
      description: {
        component: [
          ...
          "```",
          "",
          "An informative example only — the design system already ships a `Button` component",
          ...
          "example a different `userId` depending on which user is selected — don't use",
          "this HOC; use the controlled `Modal` instead.",
        ].join("\n"),
      },
      story: {
        inline: false,
