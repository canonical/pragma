/**
 * Lorem ipsum paragraph fixture — one string per paragraph. Used by the `Lorem`
 * filler component to populate story layouts (e.g. a scrolling page-content
 * area beside a navigation).
 */
export const LOREM_PARAGRAPHS: readonly string[] = [
