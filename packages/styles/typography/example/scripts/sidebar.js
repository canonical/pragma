 ...
 */
const ENGINES = [
  { id: "engine-cap", label: "Cap unit (no extraction needed)" },
  { id: "engine-metrics", label: "Metrics (extracted font metrics)" },
  { id: "engine-trim", label: "Text-trim (cap unit + text-box-trim)" },
];
