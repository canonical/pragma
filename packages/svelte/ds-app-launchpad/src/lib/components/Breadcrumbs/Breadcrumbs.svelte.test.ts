...
describe("Breadcrumbs component", () => {
  // The browser page is shared across files (isolate:false); restore the
  // default viewport after every test so a resize cannot reach the next file,
  // even when a test fails before its own restore.
  afterEach(() => {
