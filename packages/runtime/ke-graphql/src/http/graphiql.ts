// =============================================================================
// Embedded GraphiQL HTML template (KG.12). Served on GET without a query
// param when graphiql is enabled. Self-contained page; the GraphiQL assets
// load from esm.sh at runtime in the browser (dev-tool surface, not a
// production dependency of the API itself).
// =============================================================================
