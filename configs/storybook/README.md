...
## Getting Started
1. In your React or Svelte Storybook project, install this package with `bun add -d @canonical/storybook-config`
...
- This storybook config for the time being only implementing a factory for react/vite and svelte/vite. We imagine this might change to accomodate other frameworks and build tools.
